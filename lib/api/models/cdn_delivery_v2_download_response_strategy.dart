...
part 'cdn_delivery_v2_download_response_strategy.mapper.dart';
...
enum CdnDeliveryV2DownloadResponseStrategy {
  ...
  static List<CdnDeliveryV2DownloadResponseStrategy> get $valuesDefined => values.where((value) => value != CdnDeliveryV2DownloadResponseStrategy.unknown).toList();
}
