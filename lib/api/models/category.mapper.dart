...
class CategoryMapper extends ClassMapperBase<Category> {
  ...
  static String _$title(Category v) => v.title;
  static const Field<Category, String> _f$title = Field('title', _$title);

  @override
  final MappableFields<Category> fields = const {#id: _f$id, #title: _f$title};

  static Category _instantiate(DecodingData data) {
    return Category(id: data.dec(_f$id), title: data.dec(_f$title));
  }
